...
class products extends Controller
{
	...
	function cti(){
	    $meta = ['url'=>url('product/products-cti-solutions'),'title'=>'products-cti-solutions', 'description'=>"", "keywords" => ""];
		return $this->view->render('cti', ['meta'=>$meta]);
	}

	function faq1(){
	    $meta = ['url'=>url('resources/faq'),'title'=>'Guide', 'description'=>"", "keywords" => ""];
		return $this->view->render('faq1', ['meta'=>$meta]);
	}
