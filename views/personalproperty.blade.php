                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        <div class="about-title-area"></P>
                            <h2>PERSONAL PROPERTY EXCHANGES</h2>
                            <p>  </p>
                        </div>
                    </div>
                </div>
                <div class="row feature-image">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 acurate">
                        <div class="about-main-content">
                           <CENTER><iframe src="https://player.vimeo.com/video/225427021" width="400" height="270" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							</CENTER>
                        </div>
                    </div>
                </div>
