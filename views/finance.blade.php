         ...
         <div class="col-md-12">
            ...
            <div class="breadcroumb">
               <a href="{{ url('') }}">Home</a> &gt;
                  ...
                  <span class="current">{{ Seo::name('finance') }}</span>
            </div>
         </div>
      </div>
   </div>
...
<section id="about" class="service-area section-big section-padding">
   <div class="container">
      <div class="topcontent">
         ...
         <div class="row">
           <div class="col-md-12">
             <img src="{{ asset($extra_img) }}" alt="Imperium finance products deployed at Aafaq Islamic Finance and First Security Group: Avaya IPOCC and Imperium Debt Collection System">
           </div>
         </div>
         @endif
      </div>
...
<section class="section-padding">
   <div class="container">
      @include('layouts.components.aeo', ['slug' => 'finance'])
   </div>
</section>
@endsection
