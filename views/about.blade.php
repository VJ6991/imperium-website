...
@section('content')
    ...
    <div class="lite-breadcroumb-area innerbanner" id="aboutbanner">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>About Us</h1>
    ...
    <section id="about" class="service-area section-big section-padding">
        <div class="container">
            <div class="topcontent">
                <div class="row">
                    <div class="col-md-7">
                        <h2> {!! Helper::cms('about', 'main_heading', 'We Help You Connect Your Business') !!} </h2>
                        <p>
                            {!! nl2br(htmlspecialchars(Helper::cms('about', 'content_paragraph_1', 'Founded in the year 2005...'))) !!}
                        </p>
                    </div>
                    <div class="col-md-5 text-right">
                        <div class="showvideo">
                            ...
                            <img src="{{ url(Helper::cms('about', 'customer_service_image', 'assets/image/customer-service.jpg')) }}" alt="Imperium">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="videoWrapper">
                                <iframe id="videoIframe" src="https://www.youtube.com/embed/5qg1LVivohU?rel=0" allowfullscreen="" width="560" height="315" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="topcontent mission">
                ...
                <div class="contsec">
                    ...
                    <p>
                        {!! nl2br(htmlspecialchars(Helper::cms('about', 'vision_paragraph', 'Imperium\'s vision is...'))) !!}
                    </p>
                </div>

                <div class="imgsec">
                    
                     <img src="{{ url(Helper::cms('about', 'vision_image', 'assets/image/mission.jpg')) }}" alt="Imperium">
                </div>
            </div>
        </div>
    </section>

    <section class="service-area section-big section-padding subsect">
        <div class="container">
            <p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="contact-form text-center">
                        ...
                        <form name="downlaodBrochurecrm" id="downlaodBrochurecrmAbout" class="cta-form cta-light">
