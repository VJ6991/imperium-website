          ...
          <div class="main-container-index">
            <div class="main-container-div-1">
              ...
              <div>
                ...
                <a href="{{ url('cx/#/solutions') }}" class="main-container-div-1-div-button button-know-more">Know more</a>
              </div>
            </div>
...
<section class="section-3 layout">
  <div class="industry-influence-div">
    ...
    <div class="industry-influence-scroll-main">
      <!-- image 1 -->
      <a href="{{ url('cx/#/crm-connector') }}" class="industry-influence-scroll-card">
      ...
      <!-- image 2 -->
      <a href="{{ url('cx/#/social-media-connector') }}" class="industry-influence-scroll-card">
      ...
      <!-- image 3 -->
      <a href="{{ url('cx/#/out-bound-dialer') }}" class="industry-influence-scroll-card">
      ...
      <!-- img -4 -->
      <a href="{{ url('cx/#/power-bi-reports') }}" class="industry-influence-scroll-card">
...
<section class="section-cards-2 layout">
  <div class="section-card-main-div">
    <div class="section-card-head">
      ...
      <a href="{{ url('casestudy') }}" target="_blank" class="seeAll">See All</a>
    </div>
    <div class="section-cards-scroll">
      @foreach(array_slice($casestudies, 0, 4) as $cs)
      <a download target="_blank" href="{{ url($cs['pdf']) }}" class="imperium-cards">
        <img src="{{ url($cs['home_image'] ?? $cs['image']) }}" alt="" />
