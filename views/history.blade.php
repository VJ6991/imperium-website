            ...
            <div class="container">
                ...
                <div class="row feature-image">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center acurate">
                       ...
                       <img src="{{asset('img/2.jpg')}}" width="400"  alt="" title="" />
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 acurate">
                        <div class="about-main-content">
                           <CENTER><iframe src="https://player.vimeo.com/video/225327529" width="400" height="270" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                            </CENTER>
                        </div>
                    </div>
                </div>
