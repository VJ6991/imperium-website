...
function ImpFooter() {
  ...
  const baseUrl = "https://imperiumapp.com"; // Ensuring correct base URL for links
...
<style>
  ...
  /* Style.css & Main.css Ported Styles */
  ...
  #imp-main-footer .address h5 i { margin-right: 5px; }
  #imp-main-footer .address p { font-size: 13px; line-height: 20px; margin: 0 0 10px; color: #fff; }
  #imp-main-footer .address p i { font-size: 14px; width: 20px; }
